...
int main( int argc, char* argv[] )
{
	...
	std::normal_distribution<double> cycles( 5000.0, 2500.0 );
	std::normal_distribution<double> memory( 1000.0, 500.0 );
	...
	if (	outputFile.is_open()	)
	{
		...
		for( i = 0; i < numProcs; i++ )
		{
			...
			while(1)
         {
            ...
            if ( number > 8.0 && number < 5000000.0 )
				{
